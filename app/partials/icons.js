...
export const back = 'ios-arrow-back'
export const right = 'ios-arrow-forward'
export const add = Platform.OS === 'ios' ? 'ios-add' : 'md-add'
export const map = Platform.OS === 'ios' ? 'ios-map' : 'md-map'
export const call = Platform.OS === 'ios' ? 'ios-call' : 'md-call'
export const card = Platform.OS === 'ios' ? 'ios-card' : 'md-card'
...
export const camera = Platform.OS === 'ios' ? 'ios-camera' : 'md-camera'
export const search = Platform.OS === 'ios' ? 'ios-search' : 'md-search'
export const school = Platform.OS === 'ios' ? 'ios-school' : 'md-school'
export const logout = Platform.OS === 'ios' ? 'ios-log-out' : 'md-log-out'
export const navi = Platform.OS === 'ios' ? 'ios-navigate' : 'md-navigate'
export const work = Platform.OS === 'ios' ? 'ios-briefcase' : 'md-briefcase'
export const calendar = Platform.OS === 'ios' ? 'ios-calendar' : 'md-calendar'
...
export const correct = Platform.OS === 'ios' ? 'ios-checkmark-circle' : 'md-checkmark-circle'